...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleProjectIdException(ProjectIdException pex, WebRequest request) {
		ProjectIdExceptionResponse projectIdExceptionResponse = new ProjectIdExceptionResponse(pex.getMessage());
		System.out.println("CustomResponseEntityExceptionHandler called");
